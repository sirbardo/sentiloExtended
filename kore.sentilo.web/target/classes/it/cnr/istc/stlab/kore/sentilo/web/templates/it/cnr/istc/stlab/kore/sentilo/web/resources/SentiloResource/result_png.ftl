...
<textarea cols="80" name="text" rows="15">${it.text}</textarea>
</fieldset>
<fieldset>
...
<div style="text-align: center" id="fred_result">
<img style="width: 100%" src="${it.graph}" alt="FRED graph" />
<a target="_blank" href="${it.graph}">Open the graph in a new page</a>
</div>
</div> 
</@common.page>
</#escape>
